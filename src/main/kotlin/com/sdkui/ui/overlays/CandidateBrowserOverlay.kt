...
class CandidateBrowserOverlay(
    ...
    private fun populateList() {
        filteredCandidates = if (filterBuffer.isEmpty()) candidates
                             else candidates.filter { it.name.contains(filterBuffer, ignoreCase = true) }
        listBox.clearItems()
    ...
    companion object {
        fun descriptionText(sdk: Sdk, installedVersion: String?): String = buildString {
            appendLine(sdk.name)
